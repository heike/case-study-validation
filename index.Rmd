...
\hh{The automatic matching algorithm is based on a random forest [@breiman], which has a built-in internal testing mechanism to prevent potential overfitting. Error rates reported by random forest algorithms are based on these internal test sets. However, there is some discussion on whether or in which situations these error rates are biased [@rfOver2; @rfOver]. 
