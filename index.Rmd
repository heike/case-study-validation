...
blinded: 1 # to produce blinded version set to 1
titlepage: 0 # This gets changed automatically when the title page is compiled in the chunk child-doc-compile
draft: 0 # Set to 1 if figures should be included with the text
