...
\item {\bf Phoenix PD}
Tylor Klep from Phoenix PD provided sets of known and unknown bullets: the set of known bullets consists of three test fires (B1, B2, B3) from each of eight different barrels (A9, C8, F6, L5, M2, P7, R3, U10). Ten unknown bullets were provided (B, E, H, J, K N, Q, T, Y, Z). Land engraved areas for each of the six lands of each bullet were scanned by Bill Henderson (Sensofar).
\item {\bf Houston FSI}
