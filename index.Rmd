...
\hh{maximum cross-correlation is determined for aligning two signatures [@aoas, @vorburgerApplicationsCrosscorrelationFunctions2011]}
...
\hh{Note that because signatures are moved into phase based on the maximum cross-correlation rather than matching striation marks. This can result in a consecutive matching striae of 0. }
