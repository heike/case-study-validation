...
From each land engraved area a signature is derived \hh{using the process described in detail in \citet{aoas}:}

\begin{itemize}
\item[(a)] Identify an area on the LEA, striae are expressed. 
