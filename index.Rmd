...
```{r rocs, fig.caption="ROC curves for all studies based on land-to-land comparisons.", fig.width = 4.5, fig.height = 3, out.width = ".5\\textwidth"}
library(plotROC)
library(pROC)
all_lands %>% 
...
At the land level there is no difference in prediction power between RF score and cross-correlation.} 
\end{table}
