...
\item color: let's not mention 'orange' anywhere in the manuscript - I don't know, whether the printed version of the paper will be in color. 
\end{itemize}
}
