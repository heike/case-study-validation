...
\] 
where $x$ and $x+z$ are integer values appropriately defined within the domains of $S_1$ and $S_2$, $z$ is the lag between the two sequences, \svp{and }$\text{cor}(.,.)$ is the Pearson correlation coefficient.
...
\end{definition}
\svp{XXX Rearranged this slightly XXX}
