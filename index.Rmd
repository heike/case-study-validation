...
```{r signatures, fig.width = 10, fig.height = 4, fig.cap="Signatures of all six lands of bullets 1 and 2 from barrel 1 of the Hamby set 44. \\svp{The raw signature is shown in light gray and the refined signature in dark gray.}"}
