...
The algorithm in \citet{aoas} is trained on scans from Hamby sets 252 and 173 made available through \citet{nist}. Set 173 was originally published as Hamby set 44\svp{, but was mislabeled.} \svp{The scans used to fit the model were taken at a resolution of \svp{Probably need to mention that the NIST scans have a different resolution, which may affect how the results generalize?}
